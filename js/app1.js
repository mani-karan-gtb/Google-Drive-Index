...
<br>
<footer class="footer text-muted"> <div class="container"> <p class="float-right"> <a href="#">Back to top</a> </p> ${UI.credit ? '<p>Dare to Defy<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-lightning-charge-fill" fill="red" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" d="M11.251.068a.5.5 0 0 1 .227.58L9.677 6.5H13a.5.5 0 0 1 .364.843l-8 8.5a.5.5 0 0 1-.842-.49L6.323 9.5H3a.5.5 0 0 1-.364-.843l8-8.5a.5.5 0 0 1 .615-.09z" /> </svg> </p>' : ''} <p>© ${UI.copyright_year} - <a href=" ${UI.company_link}" target="_blank"> ${UI.company_name}</a>, All Rights Reserved.</p> </div> </footer>
  `;
    $('body').html(html);
}
...
<div class="input-group mb-4">
  ...
  <input type="text" class="form-control" id="dlurl" value="${href}">
	...
	<p class="card-text text-center"><a href="${href}" class="btn btn-primary">Download</a> <button onclick="copyFunction()" onmouseout="outFunc()" class="btn btn-success"> <span class="tooltiptext" id="myTooltip">Copy</span> </button></p><br></div>
<script src="https://cdn.jsdelivr.net/gh/Maverick-2000/Google-Drive-Index@2.0.8/js/ace/1.4.7/ace.js"></script>
<script src="https://cdn.jsdelivr.net/gh/Maverick-2000/Google-Drive-Index@2.0.8/js/ace/1.4.7/ext-language_tools.js"></script>`;
    $('#content').html(content);
